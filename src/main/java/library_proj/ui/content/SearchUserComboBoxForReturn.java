...
public class SearchUserComboBoxForReturn extends JPanel implements ActionListener {
...
//	private RentalService rentService;
	...
	public SearchUserComboBoxForReturn() {
		pUserList = new UserTablePanelForReturn();
