...
public class SearchBookComboBox extends JPanel implements ActionListener {
	...
	public SearchBookComboBox() {
		pBookList = new BookTablePanel();
		initialize();
	...
	private void initialize() {
		...
		JLabel lblSearchBook = new JLabel("빠른도서검색 :");
	...
	public BookTablePanel getpBookList() {
		return pBookList;
	}
